/**
 * The OverViewPage component is the main page for the overview section of the application. It displays various cards and graphs to provide an overview of the business metrics.
 *
 * The component uses the `PageContainer` component to provide a scrollable layout, and the `Tabs` component to switch between the "Overview" and "Analytics" tabs.
 *
 * The "Overview" tab displays the following:
 * - Total Revenue, Subscriptions, Sales, and Active Now cards
 * - A bar graph, a recent sales card, an area graph, and a pie graph
 *
 * The "Analytics" tab displays the same cards and graphs as the "Overview" tab, but with different data and labels.
 *
 * The component uses several UI components from the `@/components/ui` directory, such as `Button`, `Card`, `Tabs`, and others.
 */
...
import { Trip } from '@/sections/trip/trip-table/columns';
const trips: Trip[] = [
  {
    id: 'BUDDYBIKE - 241001',
...
export default function OverViewPage() {
  const averageRouteDistance =
    trips.reduce((acc, trip) => {
      // Chuyển đổi routeDistance sang số và cộng vào accumulator
      return acc + parseFloat(trip.routeDistance);
    }, 0) / trips.length;
        ...
        <div className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">+545.000 ₫</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                <div className="text-2xl font-bold">39.13%</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {averageRouteDistance.toFixed(2)} km
                </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-4 md:col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Highest rated drivers this month.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <RecentSales />
